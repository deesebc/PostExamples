...
CREATE TABLE `PROPOSTA` (
  `ID_PROPOSTA` bigint(20) NOT NULL AUTO_INCREMENT,
  `NOME` varchar(45) DEFAULT NULL,
  `CPF` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`ID_PROPOSTA`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=latin1;

INSERT INTO PROPOSTA (NOME, CPF) VALUES('Ender Game', 'CPF 1');
INSERT INTO PROPOSTA (NOME, CPF) VALUES('The stars my destination', 'CPF 2');
INSERT INTO PROPOSTA (NOME, CPF) VALUES('Dune', 'CPF 3');